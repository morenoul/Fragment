package com.example.secondfragment.fragments
...
import com.example.secondfragment.OnFragmentActionListener
...
class BlueFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            listener = it.getSerializable(("listener")) as OnFragmentActionListener
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var buttonblue = view.findViewById<Button>(R.id.bluebutton)
